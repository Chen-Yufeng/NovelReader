...
public class TextReaderActivity extends Activity implements OnClickListener, TouchListener {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_DRAW_TEXT:
                    ...
                    View recoverView = LayoutInflater.from(TextReaderActivity.this).inflate(R.layout.view_new, null);
                    View view1 = LayoutInflater.from(TextReaderActivity.this).inflate(R.layout.view_new, null);
                    View view2 = LayoutInflater.from(TextReaderActivity.this).inflate(R.layout.view_new, null);

                    rootLayout.initFlipperViews(TextReaderActivity.this, view2, view1, recoverView);
...
//        return false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_t_e_x_t);
