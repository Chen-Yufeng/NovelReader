...
public class FragmentOver extends MyBasicFragment {
...
//                    initRecyclerView();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle
            savedInstanceState) {
        mView = inflater.inflate(R.layout.fragment_over, container, false);
        initRecyclerView();
        return mView;
    }
            ...
            public void run() {
                ...
                try {
                    url = new URL("http://api.zhuishushenqi" +
                            ...
                            + "&type=over&major=" + URLEncoder.encode(mOnAttachedListener.getType()
    ...
    private void initRecyclerView() {
        RecyclerView recyclerView = mView.findViewById(R.id.fragment_over_recycler_view);
