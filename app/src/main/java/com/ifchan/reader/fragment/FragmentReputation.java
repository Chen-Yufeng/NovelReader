...
//                    initRecyclerView();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle
            savedInstanceState) {
        mView = inflater.inflate(R.layout.fragment_reputation, container, false);
        initRecyclerView();
        return mView;
    }
            ...
            public void run() {
                ...
                try {
                    url = new URL("http://api.zhuishushenqi" +
                            ...
                            + "&type=reputation&major=" + URLEncoder.encode(mOnAttachedListener.getType()
...
//            }.execute();
    ...
    private void initRecyclerView() {
        RecyclerView recyclerView = mView.findViewById(R.id.fragment_reputation_recycler_view);
